...
int main()
{
	...
	dadoTexture = Texture("Textures/Numeros.png");
	...
	Kitt_M = Model();
	Kitt_M.LoadModel("Models/CarroCarsConLogo.obj");
	Llanta_M = Model();
	Llanta_M.LoadModel("Models/RuedaConColor.obj");
	Dado_Obj_M = Model();
	Dado_Obj_M.LoadModel("Models/dado.dae");
