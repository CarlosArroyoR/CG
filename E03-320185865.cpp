...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cuerpo rojo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 2.75f, -1.5f));
		...
		//Tejado azul
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 6.8f, -1.5f));
		...
		//Ventana izq verde
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.0f, 3.75f, 0.2f));
		...
		//Puerta verde
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.3f, 0.2f));
		...
		//Ventana trasera
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.75f, 3.75f, -2.25f));
		model = glm::scale(model, glm::vec3(1.0f, 1.4f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::scale(model, glm::vec3(0.4f, 1.25f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
